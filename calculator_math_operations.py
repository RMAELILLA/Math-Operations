...
with input("Good day! Please choose what math operation you need; 'Addition', 'Subtraction', 'Multiplication' or 'Division'") as math_operator:
    for i in range(len(math_operator)):
        # evaluate the chosen math operations
        # if input is "Addition"
        if math_operator[i] == "addition":
            # ask for 2 numbers
            # display result
